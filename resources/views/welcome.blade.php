  ...
  <div id="header" class="ui grid">
    ...
    <div id="callToAction" class="six wide column">
      <div class="middle aligned content" style="margin-left: 10%; margin-top: 5%">
        ...
        <br>
        <button class="huge ui yellow basic button no-radius" style="color: #000!important">FIND A GIG</button>
        <button class="huge ui yellow basic button no-radius" style="color: #000!important">POST A GIG</button>
      </div>
    </div>
  </div>
@endsection