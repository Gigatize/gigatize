...
<nav>
    <div class="nav-wrapper z-depth-2">
        ...
        <ul class="right hide-on-med-and-down">
            ...
            <li>
                <a class="dropdown-button" href="#!" data-activates="dropdown1"><i class="user icon"></i> <i class="caret down icon"></i></a>
            </li>
        </ul>
        <ul class="side-nav" id="mobile-demo">
            ...
            <li>
                <a class="dropdown-button" href="#!" data-activates="dropdown2"><i class="user icon"></i><i class="caret down icon"></i></a>
            </li>
        </ul>
        <!-- Dropdown Structure -->
